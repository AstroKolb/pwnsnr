...
!======================================================================= 
 ...
 INTEGER, PARAMETER :: imax = 256, jmax = 256, kmax = 1    ! Memory dimensions
 INTEGER, PARAMETER :: pey = 32, pez = 1      ! number of MPI tasks
!              ####### for 2D:  ^^^  IF kmax=1, MUST HAVE pez=1   #############
 INTEGER, PARAMETER :: nvar = 9              ! number of primitive fluid variables
 ...
 REAL, DIMENSION(imax,jmax/pey,kmax/pez) :: zro, zpr, zux, zuy, zuz, zfl, zgm, zga, zcl
